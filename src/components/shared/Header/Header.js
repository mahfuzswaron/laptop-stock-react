        ...
        <nav className=' bg-white sticky top-0 z-10 '>
            <div className='flex justify-between items-center mx-20 mb-1 py-10 text-[#666666] font-bold bg-white h-16 '>
                ...
                <div className='flex space-x-4'>
                    <Link className='border-b-2 border-double border-transparent hover:border-[#0030B8]' to={'/home'}>HOME</Link>

                    <Link className='border-b-2 border-double border-transparent hover:border-[#0030B8]' to={'/inventories'}>INVENTORIES</Link>

                    {
                        user
                            ?
                            <>
                                <Link className='border-b-2 border-double border-transparent hover:border-[#0030B8]' to={'/manageinventories'}>MANAGE INVENTORIES</Link>
                                <Link className='border-b-2 border-double border-transparent hover:border-[#0030B8]' to={'/additem'}>ADD ITEM</Link>
                                <Link className='border-b-2 border-double border-transparent hover:border-[#0030B8]' to={'/myitems'}>MY ITEMS</Link>
